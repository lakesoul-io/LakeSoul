...
//        Thread.sleep(8000);
        ...
        //String key test
//        tEnvs.executeSql( "CREATE TABLE tableTest6 ( user_id STRING, dt STRING, name STRING,primary key (user_id) NOT ENFORCED ) PARTITIONED BY (dt) with ('connector' = 'lakesoul','format'='parquet','path'='"+PATH+"','lakesoul_cdc_change_column'='name','lakesoul_meta_host'='127.0.0.2','lakesoul_meta_host_port'='9043','lakesoul_cdc'='true','key'='user_id','table_name'='MetaCommon.DATA_BASE().tableTest6')" );
...
//
        ...
        table2.executeInsert("tableTest6");
