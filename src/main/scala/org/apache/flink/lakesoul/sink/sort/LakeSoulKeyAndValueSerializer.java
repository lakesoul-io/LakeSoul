...
public class LakeSoulKeyAndValueSerializer<IN> extends TypeSerializer<Tuple2<byte[], StreamRecord<IN>>> {
  ...
  LakeSoulKeyAndValueSerializer(TypeSerializer<IN> valueSerializer, int serializedKeyLength) {
  ...
  public TypeSerializer<Tuple2<byte[], StreamRecord<IN>>> duplicate() {
    return new LakeSoulKeyAndValueSerializer<>(valueSerializer.duplicate(), this.serializedKeyLength);
  }
  ...
  public boolean equals(Object o) {
    ...
    LakeSoulKeyAndValueSerializer<?> that = (LakeSoulKeyAndValueSerializer<?>) o;
