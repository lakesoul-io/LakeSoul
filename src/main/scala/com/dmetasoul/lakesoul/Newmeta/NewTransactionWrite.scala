...
import org.apache.spark.sql.lakesoul.{DelayedCommitProtocol, LakeSoulOptions, Snapshot, Transaction}
...
trait NewTransactionalWrite {
  self: NewTransaction =>
  protected def snapshot: NewSnapshot
