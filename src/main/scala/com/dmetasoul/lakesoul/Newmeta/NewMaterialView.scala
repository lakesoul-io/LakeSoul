...
import com.dmetasoul.lakesoul.Newmeta.{NewFragmentValue}
      ...
      try {
        ...
        val view_info =
          if (parttern.findFirstIn(view_info_index).isDefined
            ...
            NewFragmentValue.getEntireValue(table_id, view_info_index)
          } else {
            view_info_index
          }
        ...
        Some(MaterialViewInfo(
          view_name,
          MetaCommon.formatSqlTextFromCassandra(res.getString("sql_text")),
