...
public class WriteDataCheck {
    ...
    /**
     * param example: --csv.path file:///tmp/csv/ --lakesoul.table.path file:///tmp/lakesoul/
    ...
    public static void main(String[] args) {
        ...
        //
        //        val lakeSoulTablePath = SparkUtil.makeQualifiedTablePath(new
        // Path(lakeSoulPath)).toString
        ...
        //            System.out.println("CSV count ${csvDF.count()}, LakeSoul count
        // ${lakeSoulDF.count()}");
