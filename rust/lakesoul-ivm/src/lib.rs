...
//! ([`runtime::MinMaxView`]), and an inner equi-join of two append-only
...
pub use runtime::{
    IVM_COUNT_COLUMN, IVM_SUM_COLUMN, IVM_VALUE_COLUMN, IVM_VALUE_COUNT_COLUMN,
    IvmRuntime, JoinView, MinMaxKind, MinMaxView, SumCountView, ViewSpec,
    join_view_schema, min_max_mv_schema, min_max_state_schema, sum_count_mv_schema,
    window_key,
};
pub use table::{
