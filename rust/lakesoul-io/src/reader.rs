...
mod tests {
    ...
    async fn test_reader_s3() -> Result<()> {
        let reader_io_config = LakeSoulIOConfigBuilder::new()
            .with_files(vec![
                "s3://lakesoul-test-bucket/data/native-io-test/data.parquet".to_string(),
            ])
            .with_thread_num(1)
            .with_batch_size(8192)
            .build();
    ...
    async fn pr_1689_reader_test() {
        ...
        let io_config = LakeSoulIOConfig::builder()
            ...
            .with_option("hash_bucket_num","32")
    ...
    #[test_log::test(tokio::test)]
    async fn projection_push_down_test() {
        let schema = Schema::new(vec![
        ...
        let io_config = LakeSoulIOConfig::builder()
            .with_file("file:/tmp/bounded_table1/part-AFpU8YEs14Whc7WC_0000.parquet")
            .with_schema(Arc::new(schema))
            .with_option("is_compacted", "false")
            .with_option("skip_merge_on_read", "false")
