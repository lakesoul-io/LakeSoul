...
static ARROW_CAST_OPTIONS: OnceLock<CastOptions<'static>> = OnceLock::new();

pub fn arrow_cast_options() -> &'static CastOptions<'static> {
    ARROW_CAST_OPTIONS.get_or_init(|| CastOptions {
        safe: false,
