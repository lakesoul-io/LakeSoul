...
./bin/spark-submit \
    ...
    jars/lakesoul-spark-3.5_2.12-VAR::VERSION.jar 
    --threadpool.size=10
    --database=test
```
...
:::tip
可以为 Spark 全局压缩任务开启 [Dynamic Allocation](https://spark.apache.org/docs/3.5.8/job-scheduling.html#dynamic-resource-allocation)，使得该任务可以根据需要自动弹性伸缩资源。
:::