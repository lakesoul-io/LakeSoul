...
可以在 LakeSoul Release 页面下载：https://github.com/lakesoul-io/LakeSoul/releases/download/vVAR::VERSION/lakesoul-flink-1.20_2.12-VAR::VERSION.jar。

如果访问 Github 有问题，也可以通过这个链接下载：https://mirrors.huaweicloud.com/repository/maven/com/dmetasoul/lakesoul-flink-1.20_2.12/VAR::VERSION/lakesoul-flink-1.20_2.12-VAR::VERSION.jar

目前支持的 Flink 版本为 1.20
...
| 主程序包                 | 任务运行jar包                                                                             | lakesoul-flink-1.20_2.12-VAR::VERSION.jar                                 |
