...
//        ValueLiteralExpression valExpr = new ValueLiteralExpression(3, new AtomicDataType(new
// IntType(false)));
...
//            SimpleExtension.ScalarFunctionVariant desc =
// extensionCollection.getScalarFunction(SimpleExtension.FunctionAnchor.of("/functions_comparison.yaml", "equal:any_any"));
//            Expression.ScalarFunctionInvocation si = ExpressionCreator.scalarFunction(desc,
