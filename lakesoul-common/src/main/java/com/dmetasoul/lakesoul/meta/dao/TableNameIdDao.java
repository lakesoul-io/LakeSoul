...
public class TableNameIdDao {
    ...
    public TableNameId findByTableName(String tableName, String tableNamespace) {
        if (NativeUtils.NATIVE_METADATA_ENABLED) {
            JniWrapper jniWrapper = NativeMetadataJavaClient.query(NativeUtils.CodedDaoType.SelectTableNameIdByTableName, Arrays.asList(tableName, tableNamespace));
    ...
    public void insert(TableNameId tableNameId) {
        if (NativeUtils.NATIVE_METADATA_ENABLED) {
            Integer count = NativeMetadataJavaClient.insert(NativeUtils.CodedDaoType.InsertTableNameId, JniWrapper.newBuilder().addTableNameId(tableNameId).build());
            return;
        }
        Connection conn = null;
        PreparedStatement pstmt = null;
    ...
    public void deleteByTableId(String tableId) {
        if (NativeUtils.NATIVE_METADATA_ENABLED) {
            Integer count = NativeMetadataJavaClient.update(NativeUtils.CodedDaoType.DeleteTableNameIdByTableId, Collections.singletonList(tableId));
            return;
        }
        Connection conn = null;
        PreparedStatement pstmt = null;
