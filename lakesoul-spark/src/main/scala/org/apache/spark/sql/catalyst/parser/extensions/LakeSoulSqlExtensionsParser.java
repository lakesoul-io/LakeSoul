...
public class LakeSoulSqlExtensionsParser extends Parser {
    ...
    public static final int T__0 = 1,
            ...
            FLOAT_LITERAL = 60,
            DOUBLE_LITERAL = 61,
            BIGDECIMAL_LITERAL = 62,
            IDENTIFIER = 63,
            BACKQUOTED_IDENTIFIER = 64,
            SIMPLE_COMMENT = 65,
            BRACKETED_COMMENT = 66,
            WS = 67,
            UNRECOGNIZED = 68;
    public static final int RULE_singleStatement = 0,
            RULE_statement = 1,
            RULE_createReplaceTagClause = 2,
            RULE_createReplaceBranchClause = 3,
            RULE_tagOptions = 4,
            RULE_branchOptions = 5,
            RULE_snapshotRetention = 6,
            RULE_refRetain = 7,
            RULE_maxSnapshotAge = 8,
            RULE_minSnapshotsToKeep = 9,
            RULE_writeSpec = 10,
            RULE_writeDistributionSpec = 11,
            RULE_writeOrderingSpec = 12,
            RULE_callArgument = 13,
            RULE_singleOrder = 14,
            RULE_order = 15,
            RULE_orderField = 16,
            RULE_transform = 17,
            RULE_transformArgument = 18,
            RULE_expression = 19,
            RULE_constant = 20,
            RULE_stringMap = 21,
            RULE_stringArray = 22,
            ...
            RULE_number = 24,
            RULE_multipartIdentifier = 25,
            RULE_identifier = 26,
            RULE_quotedIdentifier = 27,
            RULE_fieldList = 28,
            RULE_nonReserved = 29,
            RULE_snapshotId = 30,
            RULE_numSnapshots = 31,
            RULE_timeUnit = 32;
    ...
    public String getGrammarFileName() {
        return "LakeSoulSqlExtensions.g4";
    }
    ...
    public static class CallContext extends StatementContext {
        public TerminalNode CALL() {
            return getToken(LakeSoulSqlExtensionsParser.CALL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterCall(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitCall(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof LakeSoulSqlExtensionsVisitor)
                return ((LakeSoulSqlExtensionsVisitor<? extends T>) visitor).visitCall(this);
    ...
    public static class SingleStatementContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(LakeSoulSqlExtensionsParser.EOF, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterSingleStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitSingleStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof LakeSoulSqlExtensionsVisitor)
                return ((LakeSoulSqlExtensionsVisitor<? extends T>) visitor)
                        .visitSingleStatement(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StringMapContext extends ParserRuleContext {
        public TerminalNode MAP() {
            return getToken(LakeSoulSqlExtensionsParser.MAP, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_stringMap;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterStringMap(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitStringMap(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof LakeSoulSqlExtensionsVisitor)
                return ((LakeSoulSqlExtensionsVisitor<? extends T>) visitor).visitStringMap(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StringArrayContext extends ParserRuleContext {
        public TerminalNode ARRAY() {
            return getToken(LakeSoulSqlExtensionsParser.ARRAY, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_stringArray;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterStringArray(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitStringArray(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof LakeSoulSqlExtensionsVisitor)
                return ((LakeSoulSqlExtensionsVisitor<? extends T>) visitor).visitStringArray(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TypeConstructorContext extends ConstantContext {
        ...
        public TerminalNode STRING() {
            return getToken(LakeSoulSqlExtensionsParser.STRING, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterTypeConstructor(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitTypeConstructor(this);
        }
    ...
    public static class NumericLiteralContext extends ConstantContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterNumericLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitNumericLiteral(this);
        }
    ...
    public static class DecimalLiteralContext extends NumberContext {
        public TerminalNode DECIMAL_VALUE() {
            return getToken(LakeSoulSqlExtensionsParser.DECIMAL_VALUE, 0);
        }

        public TerminalNode MINUS() {
            return getToken(LakeSoulSqlExtensionsParser.MINUS, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterDecimalLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitDecimalLiteral(this);
        }
    ...
    public static class BigIntLiteralContext extends NumberContext {
        public TerminalNode BIGINT_LITERAL() {
            return getToken(LakeSoulSqlExtensionsParser.BIGINT_LITERAL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterBigIntLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitBigIntLiteral(this);
        }
    ...
    public static class TinyIntLiteralContext extends NumberContext {
        public TerminalNode TINYINT_LITERAL() {
            return getToken(LakeSoulSqlExtensionsParser.TINYINT_LITERAL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterTinyIntLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitTinyIntLiteral(this);
        }
    ...
    public static class BigDecimalLiteralContext extends NumberContext {
        public TerminalNode BIGDECIMAL_LITERAL() {
            return getToken(LakeSoulSqlExtensionsParser.BIGDECIMAL_LITERAL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterBigDecimalLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitBigDecimalLiteral(this);
        }
    ...
    public static class ExponentLiteralContext extends NumberContext {
        public TerminalNode EXPONENT_VALUE() {
            return getToken(LakeSoulSqlExtensionsParser.EXPONENT_VALUE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterExponentLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitExponentLiteral(this);
        }
    ...
    public static class DoubleLiteralContext extends NumberContext {
        public TerminalNode DOUBLE_LITERAL() {
            return getToken(LakeSoulSqlExtensionsParser.DOUBLE_LITERAL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterDoubleLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitDoubleLiteral(this);
        }
    ...
    public static class IntegerLiteralContext extends NumberContext {
        public TerminalNode INTEGER_VALUE() {
            return getToken(LakeSoulSqlExtensionsParser.INTEGER_VALUE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterIntegerLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitIntegerLiteral(this);
        }
    ...
    public static class FloatLiteralContext extends NumberContext {
        public TerminalNode FLOAT_LITERAL() {
            return getToken(LakeSoulSqlExtensionsParser.FLOAT_LITERAL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterFloatLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitFloatLiteral(this);
        }
    ...
    public static class SmallIntLiteralContext extends NumberContext {
        public TerminalNode SMALLINT_LITERAL() {
            return getToken(LakeSoulSqlExtensionsParser.SMALLINT_LITERAL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterSmallIntLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitSmallIntLiteral(this);
        }
    ...
    public static class BooleanLiteralContext extends ConstantContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterBooleanLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitBooleanLiteral(this);
        }
    ...
    public static class StringLiteralContext extends ConstantContext {
        public List<TerminalNode> STRING() {
            return getTokens(LakeSoulSqlExtensionsParser.STRING);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterStringLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitStringLiteral(this);
        }
    ...
    public static class BooleanValueContext extends ParserRuleContext {
        public TerminalNode TRUE() {
            return getToken(LakeSoulSqlExtensionsParser.TRUE, 0);
        }

        public TerminalNode FALSE() {
            return getToken(LakeSoulSqlExtensionsParser.FALSE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterBooleanValue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitBooleanValue(this);
        }
    ...
    public static class ExpressionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof LakeSoulSqlExtensionsVisitor)
                return ((LakeSoulSqlExtensionsVisitor<? extends T>) visitor).visitExpression(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PositionalArgumentContext extends CallArgumentContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterPositionalArgument(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitPositionalArgument(this);
        }
    ...
    public static class NamedArgumentContext extends CallArgumentContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterNamedArgument(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitNamedArgument(this);
        }
                        ...
                        if (((((_la - 6)) & ~0x3f) == 0
                                && ((1L << (_la - 6))
                                                & ((1L << (ADD - 6))
                                                        ...
                                                        | (1L << (STRING - 6))
                                                        | (1L << (BIGINT_LITERAL - 6))
                                                        | (1L << (SMALLINT_LITERAL - 6))
                                                        | (1L << (TINYINT_LITERAL - 6))
                                                        | (1L << (INTEGER_VALUE - 6))
                                                        | (1L << (EXPONENT_VALUE - 6))
                                                        | (1L << (DECIMAL_VALUE - 6))
                                                        | (1L << (FLOAT_LITERAL - 6))
                                                        | (1L << (DOUBLE_LITERAL - 6))
                                                        | (1L << (BIGDECIMAL_LITERAL - 6))
                                                        | (1L << (IDENTIFIER - 6))
                                                        | (1L << (BACKQUOTED_IDENTIFIER - 6))))
                                        != 0)) {
                            {
                                setState(72);
                                callArgument();
    ...
    public static class MultipartIdentifierContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterMultipartIdentifier(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitMultipartIdentifier(this);
        }
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((MultipartIdentifierContext) _localctx)
                        .parts.add(((MultipartIdentifierContext) _localctx).identifier);
                setState(425);
                _errHandler.sync(this);
                _la = _input.LA(1);
                while (_la == T__4) {
    ...
    public static class NonReservedContext extends ParserRuleContext {
        public TerminalNode ADD() {
            return getToken(LakeSoulSqlExtensionsParser.ADD, 0);
        }

        public TerminalNode ALTER() {
            return getToken(LakeSoulSqlExtensionsParser.ALTER, 0);
        }

        public TerminalNode AS() {
            return getToken(LakeSoulSqlExtensionsParser.AS, 0);
        }

        public TerminalNode ASC() {
            return getToken(LakeSoulSqlExtensionsParser.ASC, 0);
        }

        public TerminalNode BRANCH() {
            return getToken(LakeSoulSqlExtensionsParser.BRANCH, 0);
        }

        public TerminalNode BY() {
            return getToken(LakeSoulSqlExtensionsParser.BY, 0);
        }
        ...
        public TerminalNode CREATE() {
            return getToken(LakeSoulSqlExtensionsParser.CREATE, 0);
        }

        public TerminalNode DAYS() {
            return getToken(LakeSoulSqlExtensionsParser.DAYS, 0);
        }

        public TerminalNode DESC() {
            return getToken(LakeSoulSqlExtensionsParser.DESC, 0);
        }

        public TerminalNode DROP() {
            return getToken(LakeSoulSqlExtensionsParser.DROP, 0);
        }

        public TerminalNode EXISTS() {
            return getToken(LakeSoulSqlExtensionsParser.EXISTS, 0);
        }

        public TerminalNode FIELD() {
            return getToken(LakeSoulSqlExtensionsParser.FIELD, 0);
        }

        public TerminalNode FIRST() {
            return getToken(LakeSoulSqlExtensionsParser.FIRST, 0);
        }

        public TerminalNode HOURS() {
            return getToken(LakeSoulSqlExtensionsParser.HOURS, 0);
        }

        public TerminalNode IF() {
            return getToken(LakeSoulSqlExtensionsParser.IF, 0);
        }

        public TerminalNode LAST() {
            return getToken(LakeSoulSqlExtensionsParser.LAST, 0);
        }

        public TerminalNode NOT() {
            return getToken(LakeSoulSqlExtensionsParser.NOT, 0);
        }

        public TerminalNode NULLS() {
            return getToken(LakeSoulSqlExtensionsParser.NULLS, 0);
        }

        public TerminalNode OF() {
            return getToken(LakeSoulSqlExtensionsParser.OF, 0);
        }

        public TerminalNode OR() {
            return getToken(LakeSoulSqlExtensionsParser.OR, 0);
        }

        public TerminalNode ORDERED() {
            return getToken(LakeSoulSqlExtensionsParser.ORDERED, 0);
        }

        public TerminalNode PARTITION() {
            return getToken(LakeSoulSqlExtensionsParser.PARTITION, 0);
        }

        public TerminalNode TABLE() {
            return getToken(LakeSoulSqlExtensionsParser.TABLE, 0);
        }

        public TerminalNode WRITE() {
            return getToken(LakeSoulSqlExtensionsParser.WRITE, 0);
        }

        public TerminalNode DISTRIBUTED() {
            return getToken(LakeSoulSqlExtensionsParser.DISTRIBUTED, 0);
        }

        public TerminalNode LOCALLY() {
            return getToken(LakeSoulSqlExtensionsParser.LOCALLY, 0);
        }

        public TerminalNode MINUTES() {
            return getToken(LakeSoulSqlExtensionsParser.MINUTES, 0);
        }

        public TerminalNode MONTHS() {
            return getToken(LakeSoulSqlExtensionsParser.MONTHS, 0);
        }

        public TerminalNode UNORDERED() {
            return getToken(LakeSoulSqlExtensionsParser.UNORDERED, 0);
        }

        public TerminalNode REPLACE() {
            return getToken(LakeSoulSqlExtensionsParser.REPLACE, 0);
        }

        public TerminalNode RETAIN() {
            return getToken(LakeSoulSqlExtensionsParser.RETAIN, 0);
        }

        public TerminalNode VERSION() {
            return getToken(LakeSoulSqlExtensionsParser.VERSION, 0);
        }

        public TerminalNode WITH() {
            return getToken(LakeSoulSqlExtensionsParser.WITH, 0);
        }

        public TerminalNode IDENTIFIER_KW() {
            return getToken(LakeSoulSqlExtensionsParser.IDENTIFIER_KW, 0);
        }

        public TerminalNode FIELDS() {
            return getToken(LakeSoulSqlExtensionsParser.FIELDS, 0);
        }

        public TerminalNode SET() {
            return getToken(LakeSoulSqlExtensionsParser.SET, 0);
        }

        public TerminalNode SNAPSHOT() {
            return getToken(LakeSoulSqlExtensionsParser.SNAPSHOT, 0);
        }

        public TerminalNode SNAPSHOTS() {
            return getToken(LakeSoulSqlExtensionsParser.SNAPSHOTS, 0);
        }

        public TerminalNode TAG() {
            return getToken(LakeSoulSqlExtensionsParser.TAG, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterNonReserved(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitNonReserved(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof LakeSoulSqlExtensionsVisitor)
                return ((LakeSoulSqlExtensionsVisitor<? extends T>) visitor).visitNonReserved(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class UnquotedIdentifierContext extends IdentifierContext {
        public TerminalNode IDENTIFIER() {
            return getToken(LakeSoulSqlExtensionsParser.IDENTIFIER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterUnquotedIdentifier(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitUnquotedIdentifier(this);
        }
    ...
    public static class QuotedIdentifierContext extends ParserRuleContext {
        public TerminalNode BACKQUOTED_IDENTIFIER() {
            return getToken(LakeSoulSqlExtensionsParser.BACKQUOTED_IDENTIFIER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterQuotedIdentifier(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitQuotedIdentifier(this);
        }
    ...
    public static class QuotedIdentifierAlternativeContext extends IdentifierContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).enterQuotedIdentifierAlternative(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LakeSoulSqlExtensionsListener)
                ((LakeSoulSqlExtensionsListener) listener).exitQuotedIdentifierAlternative(this);
        }
