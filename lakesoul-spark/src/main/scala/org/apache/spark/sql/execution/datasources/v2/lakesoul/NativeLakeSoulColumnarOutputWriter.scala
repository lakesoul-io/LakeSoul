...
class NativeLakeSoulColumnarOutputWriter(path: String, dataSchema: StructType, timeZoneId: String,
...
private[v2] trait NativeLakeSoulColumnarOutputWriterSupport extends OutputWriter {
