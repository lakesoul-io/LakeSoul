...
public class LakeSoulSqlExtensionsBasicVisitor<T> extends AbstractParseTreeVisitor<T>
        implements LakeSoulSqlExtensionsVisitor<T> {
    @Override
    ...
    public T visitQuotedIdentifierAlternative(
            LakeSoulSqlExtensionsParser.QuotedIdentifierAlternativeContext ctx) {
        return visitChildren(ctx);
    }
