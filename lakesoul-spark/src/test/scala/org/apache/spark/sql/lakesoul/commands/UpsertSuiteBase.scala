...
class UpsertSuiteBase
  ...
  protected def checkUpsert(
    ...
    checkAnswer(
      readLakeSoulTable(tempPath).select(colNames.map(col): _*),
      expectedResults
    )
  }

  protected def checkBigDataUpsert(
      df: DataFrame,
      condition: Option[String],
    ...
    executeUpsert(df, condition, tableName.getOrElse(tempPath))
    val starData =
      readLakeSoulTable(tempPath).select(colNames.map(col): _*).rdd.persist()
  ...
  protected def checkUpsertByFilter(
      df: DataFrame,
      condition: Option[String],
      expectedResults: Seq[Row],
      filter: String,
  ...
  protected def checkUpsertBySelect(
      df: DataFrame,
      condition: Option[String],
      expectedResults: Seq[Row],
      selectCols: String,
    ...
    val starDF = readLakeSoulTable(tempPath)
      .select(selectCols.split(",").map(col): _*)
      .persist()
  ...
  test("merge - same column") {
    ...
    checkUpsert(
      Seq((20201101, 1, 11), (20201101, 3, 33), (20201101, 4, 44))
        .toDF("range", "hash", "value"),
      None,
      Row(20201101, 1, 11) :: Row(20201101, 2, 2) :: Row(
        20201101,
        3,
        33
      ) :: Row(20201101, 4, 44) :: Row(20201102, 4, 4) :: Nil,
  ...
  test("merge - same column - partial partition filter") {
    ...
    checkUpsertByFilter(
      Seq(
        ...
        .toDF("range", "hash", "value1", "value2"),
      None,
      Row(20201101, 1, 11, "a") :: Row(20201101, 2, 2, "a") :: Row(
        20201101,
        3,
        3,
        "b"
  ...
  test("merge - different columns") {
    ...
    withSQLConf(LakeSoulSQLConf.SCHEMA_AUTO_MIGRATE.key -> "true") {
      checkUpsert(
        ...
        None,
        Row(20201101, 1, 1, 11) :: Row(20201101, 2, 2, null) :: Row(
          20201101,
          3,
          3,
          33
        ) :: Row(20201101, 4, null, 44) :: Row(20201102, 4, 4, null) :: Nil,
    ...
    withSQLConf(LakeSoulSQLConf.SCHEMA_AUTO_MIGRATE.key -> "true") {
      checkUpsertByFilter(
        Seq((20201101, 1, 11), (20201101, 3, 33), (20201101, 4, 44))
          .toDF("range", "hash", "name"),
        None,
        Row(20201101, 1, 1) :: Row(20201101, 3, 3) :: Row(
          20201101,
          4,
          null
        ) :: Nil,
    ...
    withSQLConf(LakeSoulSQLConf.SCHEMA_AUTO_MIGRATE.key -> "true") {
      checkUpsertByFilter(
        Seq(
          ...
          .toDF("range", "hash", "value"),
        None,
        Row(20201101, 1, 2, 11) :: Row(20201101, 2, 2, 22) :: Row(
          20201101,
          3,
          4,
          33
  ...
  test("basic upsert - same columns") {
    ...
    checkAnswer(
      readLakeSoulTable(tempPath).select("range", "hash", "value"),
      Row(20201101, 1, 1) :: Row(20201101, 2, 2) :: Row(20201101, 3, 3) :: Row(
        20201102,
        4,
        4
      ) :: Nil
    ...
    assert(
      e.getMessage()
        .contains("Some condition for range partition should be declared")
    )
  ...
  test(
    "should failed to upsert external columns when SCHEMA_AUTO_MIGRATE is false"
  ) {
    initTable(
      Seq(
        (20201101, 1, 1),
    ...
    val e = intercept[AnalysisException] {
      checkUpsert(
        Seq((20201101, 1, 11), (20201101, 3, 33), (20201101, 4, 44))
          .toDF("range", "hash", "value"),
        None,
        Row(20201101, 1, 11) :: Row(20201101, 3, 33) :: Row(
          20201101,
          4,
          44
        ) :: Nil,
  ...
  test("upsert without hash partitions - should fail") {
    ...
    assert(
      e.getMessage()
        .contains("Table should define Hash partition column to use upsert")
    )
  }
  ...
  test("upsert with multiple range and hash partitions") {
    ...
    checkUpsert(
      Seq(
        ...
        .toDF("range1", "range2", "hash1", "hash2", "value"),
      None,
      Row(20201101, 1, 1, 1, 11) :: Row(20201101, 2, 2, 2, 2) :: Row(20201101,
        3, 3, 3, 33) :: Row(20201101, 4, 4, 4, 44) :: Row(20201102, 4, 4, 4,
        4) :: Nil,
      ...
      i match {
        case 1 =>
          checkUpsertByFilter(
            Seq((20201102, 1, 11), (20201102, 3, 33), (20201102, 4, 44))
              .toDF("range", "hash", "value"),
            None,
            Row(20201102, 1, 11, null, null) :: Row(20201102, 3, 33, null,
              null) :: Row(20201102, 4, 44, null, null) :: Nil,
            "range=20201102",
        ...
        case 2 =>
          ...
          checkUpsertByFilter(
            Seq(
              ...
              .toDF("range", "hash", "value", "name"),
            None,
            Row(20201102, 1, 111, 11, null) :: Row(20201102, 2, 222, 22,
              null) :: Row(20201102, 3, 333, 33, null) :: Row(20201102, 4, 44,
              null, null) :: Nil,
            "range=20201102",
            Seq("range", "hash", "value", "name", "age")
          )
        ...
        case 3 =>
          ...
          checkUpsertByFilter(
            ...
            None,
            Row(20201102, 1, null, 11, 111) :: Row(20201102, 2, 222, 22,
              null) :: Row(20201102, 3, null, 33, 333) :: Row(20201102, 4, 44,
              null, null) :: Nil,
            "range=20201102",
            Seq("range", "hash", "value", "name", "age")
          )
      ...
      if (i == 2) {
        ...
        checkUpsertBySelect(
          Seq(
            ...
            .toDF("range", "hash", "value", "name"),
          None,
          Row(1) :: Row(2) :: Row(null) :: Row(null) :: Row(null) :: Row(
            null
          ) :: Nil,
          "age"
        )
  ...
  Range(1, 4).foreach(i => {
    test(
      "derange hash key and data schema order - int type, upsert time: " + i
    ) {
      ...
      if (i == 1) {
        checkUpsertByFilter(
          ...
          None,
          Row(20201102, 1, 12, 1, null, null) :: Row(20201102, 3, 32, 3, null,
            null) :: Row(20201102, 4, 42, 4, null, null) :: Nil,
          "range=20201102",
      ...
      if (i == 2) {
        ...
        checkUpsertByFilter(
          ...
          None,
          Row(20201102, 1, 12, 1, 11, null) :: Row(20201102, 2, 22, null, 22,
            null) :: Row(20201102, 3, 32, 3, 33, null) :: Row(20201102, 4, 42,
            4, null, null) :: Nil,
          "range=20201102",
          Seq("range", "hash1", "hash2", "value", "name", "age")
        )
      ...
      if (i == 3) {
        ...
        checkUpsertByFilter(
          Seq(
            (20201102, 4567, 42, 456, 4),
            (20201102, 2345, 22, 234, 2),
            (20201102, 3456, 32, 345, 3)
          )
            .toDF("range", "age", "hash2", "name", "hash1"),
          None,
          Row(20201102, 1, 12, 1, 11, null) :: Row(20201102, 3, 32, 3, 345,
            3456) :: Row(20201102, 4, 42, 4, 456, 4567) :: Nil,
  ...
  Range(1, 4).foreach(i => {
    test(
      "derange hash key and data schema order - string type, upsert times: " + i
    ) {
      initTable(
        Seq(
          ("20201101", "1", "1", "1", "1", "1"),
      ...
      if (i == 1) {
        checkUpsertByFilter(
          Seq(
            ...
            .toDF("range", "hash1", "hash2", "value"),
          None,
          Row("20201102", "1", "12", "1", null, null) :: Row(
            "20201102",
            "3",
            "32",
            "3",
            null,
            null
          ) :: Row("20201102", "4", "42", "4", null, null) :: Nil,
          "range='20201102'",
          Seq("range", "hash1", "hash2", "value", "name", "age")
        )
      }
      ...
      if (i == 2) {
        ...
        checkUpsertByFilter(
          Seq(
            ...
            .toDF("range", "hash2", "name", "hash1"),
          None,
          Row("20201102", "1", "12", "1", "11", null) :: Row(
            "20201102",
            "2",
            "22",
            null,
            "22",
            null
          ) :: Row("20201102", "3", "32", "3", "33", null) :: Row(
            "20201102",
            "4",
            "42",
            "4",
      ...
      if (i == 3) {
        ...
        checkUpsertByFilter(
          ...
          Row("20201102", "1", "12", "1", "11", null) :: Row(
            ...
            "345",
            "3456"
          ) :: Row("20201102", "4", "42", "4", "456", "4567") :: Nil,
          "range='20201102' and value IS NOT NULL",
          Seq("range", "hash1", "hash2", "value", "name", "age")
        )
      }
  ...
  test("create table with hash key disordered") {
    withTempDir(dir => {
      ...
      checkAnswer(table.toDF.select("v1", "v2"), requiredDF.select("v1", "v2"))
  ...
  test("merge - same column with timestamp type") {
    ...
    checkUpsert(
      Seq((20201101, 1, 11), (20201101, 3, 33), (20201101, 4, 44))
        .toDF("range", "hash", "value"),
      None,
      Row(20201101, 1, 11, ts1) :: Row(20201101, 2, 2, ts2) :: Row(
        20201101,
        3,
        33,
        ts3
      ) :: Row(20201101, 4, 44, null) :: Row(20201102, 4, 4, ts4) :: Nil,
  ...
  test("merge - different columns with timestamp type") {
    ...
    withSQLConf(LakeSoulSQLConf.SCHEMA_AUTO_MIGRATE.key -> "true") {
      checkUpsert(
        ...
        None,
        Row(20201101, 1, 1, 11, ts1) :: Row(20201101, 2, 2, null, null) :: Row(
          20201101,
          3,
          3,
          33,
          ts3
        ) :: Row(20201101, 4, null, 44, ts4) :: Row(20201102, 4, 4, null,
          null) :: Nil,
  ...
  test("merge - different partition columns with timestamp type") {
    ...
    initTable(
      Seq(
        (20201101, 1, 1, ts1, ts1),
        (20201101, 2, 2, ts2, ts2),
        (20201101, 3, 3, ts3, ts3),
        (20201102, 4, 4, ts4, ts4)
      )
    ...
    withSQLConf(LakeSoulSQLConf.SCHEMA_AUTO_MIGRATE.key -> "true") {
      checkUpsert(
        Seq(
          (20201101, 1, 11, ts1, ts1),
          (20201101, 3, 33, ts3, ts3),
          (20201101, 4, 44, ts4, ts4)
        )
          .toDF("range", "hash", "name", "timestamp", "part_timestamp"),
        None,
        Row(20201101, 1, 1, 11, ts1, ts1) :: Row(
          20201101,
          2,
          2,
          null,
          ts2,
          ts2
        ) :: Row(20201101, 3, 3, 33, ts3, ts3) :: Row(
          20201101,
          4,
          null,
          44,
          ts4,
          ts4
        ) :: Row(20201102, 4, 4, null, ts4, ts4) :: Nil,
  ...
  test("hash value") {
    ...
    sql(
      "select hash(cast(1 as long)), hash(cast(2 as long)), hash(cast(3 as long)), hash(cast(4 as long))"
    ).show()
    ...
    sql(
      "select hash(cast(1.0 as double)), hash(cast(2.0 as double)), hash(cast(3.0 as double)), hash(cast(4.0 as double))"
    ).show()
    ...
    println(
      "string 321: " + Murmur3HashFunction.hash(
        UTF8String.fromString("321"),
        StringType,
        42
      )
    )
    println(
      "bytes [1]: " + Murmur3HashFunction.hash(
        Array('1'.toByte),
        createArrayType(ShortType),
        42
      )
    )
    ...
    println("double 0.0 :" + Murmur3HashFunction.hash(0.0, DoubleType, 42))
    println(
      "integer 1065353216: " + Murmur3HashFunction.hash(
        1065353216,
        IntegerType,
        42
      )
    ...
    println(
      "string 321,321: " + Murmur3HashFunction.hash(
        UTF8String.fromString("321"),
        StringType,
    ...
    println(
      "string 1,12: " + Murmur3HashFunction.hash(
        UTF8String.fromString("12"),
        StringType,
        Murmur3HashFunction.hash(UTF8String.fromString("1"), StringType, 42)
      )
    )
    println(
      "string 2,22: " + Murmur3HashFunction.hash(
        UTF8String.fromString("22"),
        StringType,
