...
public class StreamReadSuite extends AbstractTestBase {
    ...
    private final List<Tuple2<Integer, Integer>> BUCKET_NUM_AND_PARALLELISM =
            Arrays.asList(new Tuple2<>(3, 2), new Tuple2<>(2, 3));
    ...
    public void testLakesoulSourceIncrementalStream() {
        for (Tuple2<Integer, Integer> tup : BUCKET_NUM_AND_PARALLELISM) {
            ...
            System.out.println(
                    "testLakesoulSourceIncrementalStream with hashBucketNum="
                            + hashBucketNum
                            + ", parallelism="
                            + parallelism);
            ...
            String createUserSql =
                    "create table test_stream ("
                            ...
                            + "    'path'='"
                            + getTempDirUri("/lakeSource/test_stream")
                            + "' )";
            ...
            String testSql =
                    String.format(
                            "select * from test_stream /*+"
                                + " OPTIONS('readstarttime'='%s','readtype'='incremental','timezone'='Africa/Accra',"
                                + " 'discoveryinterval'='1000')*/",
                            TestUtils.getDateTimeFromTimestamp(
            ...
            LakeSoulTestUtils.checkStreamingQueryAnswer(
                    ...
                    (s) -> {
                        try {
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO test_stream VALUES (1, 'Bob', 90), (2,"
                                                    + " 'Alice', 80)")
                                    .await();
                            createTableEnv
                                    .executeSql("INSERT INTO test_stream VALUES (3, 'Jack', 75)")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO test_stream VALUES (4, 'Jack', 95),(5,"
                                                    + " 'Tom', 75)")
                                    .await();
                            createTableEnv
                                    .executeSql("INSERT INTO test_stream VALUES (6, 'Tom', 100)")
                                    .await();
    ...
    public void testLakesoulSourceSelectMultiRangeAndHashConditionAnd() {
        for (Tuple2<Integer, Integer> tup : BUCKET_NUM_AND_PARALLELISM) {
            ...
            int parallelism = tup.f1;
            System.out.println(
                    "testLakesoulSourceSelectMultiRangeAndHash with hashBucketNum="
                            + hashBucketNum
                            + ", parallelism="
                            + parallelism);
            TableEnvironment createTableEnv = LakeSoulTestUtils.createTableEnvInBatchMode();
            ...
            LakeSoulTestUtils.checkStreamingQueryAnswer(
                    ...
                    (s) -> {
                        try {
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_multi VALUES (1, 'Bob', 90,"
                                                + " TO_DATE('1995-10-01'), 'China'), (2, 'Alice',"
                                                + " 80, TO_DATE('1995-10-10'), 'China')")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_multi VALUES (3, 'Jack', 75, "
                                                    + " TO_DATE('1995-10-15'), 'China')")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_multi VALUES (3, 'Amy', 95, "
                                                + " TO_DATE('1995-10-10'),'UK'), (4, 'Mike', 70,"
                                                + " TO_DATE('1995-10-15'), 'UK')")
                                    .await();
                        } catch (InterruptedException | ExecutionException e) {
                            throw new RuntimeException(e);
                        }
    ...
    public void testLakesoulSourceSelectMultiRangeAndHashConditionOr() {
        for (Tuple2<Integer, Integer> tup : BUCKET_NUM_AND_PARALLELISM) {
            ...
            String testMultiRangeSelect =
                    "select id, name from user_multi"
                            + " /*+ OPTIONS('discoveryinterval'='1000')*/ "
    ...
    public void testLakesoulSourceSelectWhere() {
        for (Tuple2<Integer, Integer> tup : BUCKET_NUM_AND_PARALLELISM) {
            ...
            int parallelism = tup.f1;
            System.out.println(
                    "testLakesoulSourceSelectWhere with hashBucketNum="
                            + hashBucketNum
                            + ", parallelism="
                            + parallelism);
            TableEnvironment createTableEnv = LakeSoulTestUtils.createTableEnvInBatchMode();
            ...
            String createUserSql =
                    "create table user_info ("
                            ...
                            + String.format("    'hashBucketNum'='%d',", hashBucketNum)
                            + "    'path'='"
                            + getTempDirUri("/lakeSource/user_info")
                            + "' )";
            createTableEnv.executeSql("DROP TABLE if exists user_info");
            createTableEnv.executeSql(createUserSql);

            String testSelectWhere =
            ...
            LakeSoulTestUtils.checkStreamingQueryAnswer(
                    ...
                    (s) -> {
                        try {
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info VALUES (1, 'Bob', 90), (2,"
                                                    + " 'Alice', 80)")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info VALUES (3, 'Jack', 75), (3,"
                                                    + " 'Amy', 95)")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info VALUES (5, 'Tom', 75), (4,"
                                                    + " 'Mike', 70)")
                                    .await();
                        } catch (InterruptedException | ExecutionException e) {
                            throw new RuntimeException(e);
    ...
    public void testLakesoulSourceSelectJoin() {
        for (Tuple2<Integer, Integer> tup : BUCKET_NUM_AND_PARALLELISM) {
            ...
            int parallelism = tup.f1;
            System.out.println(
                    "testLakesoulSourceSelectJoin with hashBucketNum="
                            + hashBucketNum
                            + ", parallelism="
                            + parallelism);
            TableEnvironment createTableEnv = LakeSoulTestUtils.createTableEnvInBatchMode();
            ...
            String createUserSql =
                    "create table user_info2 ("
                            ...
                            + String.format("    'hashBucketNum'='%d',", hashBucketNum)
                            + "    'path'='"
                            + getTempDirUri("/lakeSource/user_info2")
                            + "' )";
            ...
            String createOrderSql =
                    "create table order_info ("
                            ...
                            + String.format("    'hashBucketNum'='%d',", hashBucketNum)
                            + "    'path'='"
                            + getTempDirUri("/lakeSource/order")
                            + "' )";
            createTableEnv.executeSql("DROP TABLE if exists order_info");
            createTableEnv.executeSql(createOrderSql);

            String testSelectJoin =
                    "select ui.order_id,sum(oi.price) as total_price,count(*) as total "
                            + "from user_info2"
                            + " /*+ OPTIONS('discoveryinterval'='1000')*/ "
                            + " as ui inner join "
                            + "order_info "
            ...
            LakeSoulTestUtils.checkStreamingQueryAnswer(
                    ...
                    "multi_join",
                    testSelectJoin,
                    "    order_id INT," + "    total_price DOUBLE," + "    total BIGINT NOT NULL",
                    (s) -> {
                        try {
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info2 VALUES (1, 'Bob', 90), (2,"
                                                    + " 'Alice', 80)")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO order_info VALUES (1, 20.12), (2, 10.88)")
                                    .await();

                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info2 VALUES (3, 'Jack', 75), (3,"
                                                    + " 'Amy', 95)")
                                    .await();
                            createTableEnv
                                    .executeSql("INSERT INTO order_info VALUES (3, 15.35)")
                                    .await();

                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info2 VALUES (5, 'Tom', 75), (4,"
                                                    + " 'Mike', 70)")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO order_info VALUES (4, 25.24), (5, 15.04)")
                                    .await();
                        } catch (InterruptedException | ExecutionException e) {
                            throw new RuntimeException(e);
                        }
        ...
        for (Tuple2<Integer, Integer> tup : BUCKET_NUM_AND_PARALLELISM) {
            ...
            String createUserSql =
                    "create table user_info3 ("
                            ...
                            + String.format("    'hashBucketNum'='%d',", hashBucketNum)
                            + "    'path'='"
                            + getTempDirUri("/lakeSource/user_info3")
                            + "' )";
            createTableEnv.executeSql("DROP TABLE if exists user_info3");
            createTableEnv.executeSql(createUserSql);

            String testSelectDistinct =
                    "select distinct order_id from user_info3"
                            + " /*+ OPTIONS('discoveryinterval'='1000')*/ "
                            + " where order_id<5";
            ...
            LakeSoulTestUtils.checkStreamingQueryAnswer(
                    ...
                    (s) -> {
                        try {
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info3 VALUES (1, 'Bob', 90), (2,"
                                                    + " 'Alice', 80)")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info3 VALUES (3, 'Jack', 75), (3,"
                                                    + " 'Amy', 95)")
                                    .await();
                            createTableEnv
                                    .executeSql(
                                            "INSERT INTO user_info3 VALUES (5, 'Tom', 75), (4,"
                                                    + " 'Mike', 70)")
                                    .await();
                        } catch (InterruptedException | ExecutionException e) {
                            throw new RuntimeException(e);
