    ...
    public static void createLakeSoulSourceTableUser(TableEnvironment tEnvs)
        ...
        String createUserSql =
                "create table user_info ("
                        ...
                        + String.format(
                                "    'path'='%s' )",
                                AbstractTestBase.getTempDirUri("lakesoulSource/user"));
        tEnvs.executeSql("DROP TABLE if exists user_info");
        tEnvs.executeSql(createUserSql);
        tEnvs.executeSql(
                        "INSERT INTO user_info VALUES (1, 'Bob', 90), (2, 'Alice', 80), (3, 'Jack',"
                                + " 75), (3, 'Amy', 95),(5, 'Tom', 75), (4, 'Mike', 70)")
                .await();
    }
    ...
    public static void createLakeSoulSourceViewUser(TableEnvironment tEnvs)
        ...
        String createUser1Sql =
                "create table user_info1 ("
                        ...
                        + String.format(
                                "    'path'='%s' )",
                                AbstractTestBase.getTempDirUri("lakesoulSource/user1"));
        tEnvs.executeSql("DROP TABLE if exists user_info1");
        tEnvs.executeSql(createUser1Sql);
        tEnvs.executeSql(
                        "INSERT INTO user_info1 VALUES (1, 'Bob', 91), (2, 'Alice', 81), (3,"
                                + " 'Jack', 76), (3, 'Amy', 96), (4, 'Mike', 71)")
                .await();
        String createViewSql =
                "create view if not exists user_info_view as select a.name,a.score as"
                        + " a_score,b.score as b_score from user_info as a join user_info1 as b on"
                        + " a.name = b.name where a.score > 80 ";
    ...
    public static void createLakeSoulSourceMultiPartitionTable(TableEnvironment tEnvs)
        ...
        String createSql =
                "create table user_multi ("
                        ...
                        + String.format(
                                "    'path'='%s' )",
                                AbstractTestBase.getTempDirUri("/lakeSource/multi_range_hash"));
    ...
    public static void createLakeSoulSourceMultiPartitionTable2(TableEnvironment tEnvs)
        ...
        String createSql =
                "create table user_multi2 ("
                        ...
                        + "PRIMARY KEY (`id`,`name`) NOT ENFORCED"
                        + ") "
                        + "PARTITIONED BY (`region`,`time`)"
                        + "WITH ("
                        + "    'format'='lakesoul',"
                        + "    'hashBucketNum'='2',"
                        + String.format(
                                "    'path'='%s' )",
                                AbstractTestBase.getTempDirUri("/lakeSource/multi_range_hash2"));
        tEnvs.executeSql("DROP TABLE if exists user_multi2");
        tEnvs.executeSql(createSql);
        tEnvs.executeSql(
                        "INSERT INTO user_multi2 VALUES(1, 'Bob', 90, TO_TIMESTAMP('1990-10-01"
                            + " 10:10:10.100101'), 'China'),(2, 'Alice', 80,"
                            + " TO_TIMESTAMP('1990-10-10 10:10:10.100101'), 'China'), (3, 'Jack',"
                            + " 75,  TO_TIMESTAMP('1990-10-15 10:10:10.100101'), 'China'),(3,"
                            + " 'Amy', 95,  TO_TIMESTAMP('1990-10-10 10:10:10.100101'),'UK'), (5,"
                            + " 'Tom', 75,  TO_TIMESTAMP('1990-10-01 10:10:10.100101'), 'UK'),(4,"
                            + " 'Mike', 70, TO_TIMESTAMP('1990-10-15 10:10:10.100101'), 'UK')")
                .await();
    }
    ...
    public static void createLakeSoulSourceTableOrder(TableEnvironment tEnvs)
        ...
        String createOrderSql =
                "create table order_info ("
                        ...
                        + String.format(
                                "    'path'='%s' )",
                                AbstractTestBase.getTempDirUri("/lakeSource/order"));
        tEnvs.executeSql("DROP TABLE if exists order_info");
        tEnvs.executeSql(createOrderSql);
        tEnvs.executeSql(
                        "INSERT INTO order_info VALUES (1, 20.12), (2, 10.88), (3, 15.35), (4,"
                                + " 25.24), (5, 15.04)")
                .await();
    }
}
