...
public class LakeSoulDataGenSourceTable {
    /**
     * param example: --sink.database.name flink_source --sink.table.name source_table
     * --job.checkpoint_interval 10000 --server_time_zone UTC --sink.parallel 2 --warehouse.path
     * file:///tmp/data --flink.checkpoint file:///tmp/chk --data.size 1000 --write.time 5
     */
    public static void main(String[] args) throws Exception {
        ...
        DataType structured =
                DataTypes.STRUCTURED(
                        ...
                        DataTypes.FIELD(
                                "col_6", DataTypes.DECIMAL(10, 3).bridgedTo(BigDecimal.class)),
    ...
    public static void writeData(TableEnvironment tEnvs, Table sourceTable, String sinkTableName)
            throws Exception {
