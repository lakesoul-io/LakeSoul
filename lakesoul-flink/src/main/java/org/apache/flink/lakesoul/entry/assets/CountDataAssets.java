    ...
    public static void main(String[] args) throws Exception {
        ...
        port =
                parameter.getInt(
                        ...
                        (Integer) SourceOptions.SOURCE_DB_PORT.defaultValue());
        slotName = parameter.get(SourceOptions.SLOT_NAME.key());
        pluginName = parameter.get(SourceOptions.PLUG_NAME.key());
        splitSize =
                parameter.getInt(
                        SourceOptions.SPLIT_SIZE.key(),
                        (Integer) SourceOptions.SPLIT_SIZE.defaultValue());
        ...
        sourceParallelism =
                parameter.getInt(
                        ...
                        (Integer) SourceOptions.SOURCE_PARALLELISM.defaultValue());
        fetchSize =
                parameter.getInt(
                        SourceOptions.FETCH_SIZE.key(),
                        (Integer) SourceOptions.FETCH_SIZE.defaultValue());
        startMode =
                parameter.get(
        ...
        jdbcBatchSize =
                parameter.getInt(
                        SourceOptions.JDBC_SINK_BATCH_SIZE.key(),
                        SourceOptions.JDBC_SINK_BATCH_SIZE.defaultValue());
        sinkInterval =
                parameter.getInt(
                        SourceOptions.SINK_INTERVAL.key(),
                        SourceOptions.SINK_INTERVAL.defaultValue());
        dealingDataSkew =
                parameter.getBoolean(
                        SourceOptions.DEALING_WITH_DATA_SKEW.key(),
                        SourceOptions.DEALING_WITH_DATA_SKEW.defaultValue());
        ...
        SingleOutputStreamOperator<Tuple3<String, String, String[]>> mainProcess =
                postgresParallelSource.map(new PartitionLevelAssets.metaMapper());

        DataStream<TableCounts> datacommitInfoStream =
                mainProcess
                        .keyBy(
                                (value) -> {
                                    return (String) value.f1;
                                })
                        .process(new PartitionLevelAssets.PartitionLevelProcessFunction())
                        .keyBy(
                                (value) -> {
        ...
        SingleOutputStreamOperator<TableCounts> tableCountsLatestStreaming =
                datacommitInfoStream
        ...
        if (dealingDataSkew) {
            tableCountsStreaming =
                    tableCountsLatestStreaming
                            .process(new Desalting())
                            .keyBy(value -> value.tableId)
                            .process(new JdbcTableLevelAssets());
        } else {
            tableCountsStreaming =
                    tableCountsLatestStreaming
                            .keyBy(value -> value.tableId)
        ...
        JdbcConnectionOptions build =
                (new JdbcConnectionOptions.JdbcConnectionOptionsBuilder())
                        ...
                        .build();
        String tableLevelAssetsSql =
                "INSERT INTO table_level_assets ("
                        + "table_id, "
                        + "table_name, "
                        + "domain, "
                        + "creator, "
        ...
        SinkFunction<TableCountsWithTableInfo> sink =
                JdbcSink.sink(
                        tableLevelAssetsSql,
                        (ps, t) -> {
        ...
        String dataBaseLevelAssetsSql =
                "INSERT INTO namespace_level_assets (namespace, "
                        + "table_counts, "
                        + "partition_counts, "
                        + "file_counts, "
                        + "file_total_size, "
                        ...
                        + "file_base_size = EXCLUDED.file_base_size";
        SinkFunction<NameSpaceCount> namespaceAssetsSink =
                JdbcSink.sink(
        ...
        tableCountsStreaming
                ...
                .name("namespaceAssetsSink");
        String domainLevelAssetsSql =
                "INSERT INTO domain_level_assets (domain, "
                        + "table_counts, "
                        + "partition_counts, "
                        + "file_counts, "
                        + "file_total_size, "
                        ...
                        + "file_base_counts = EXCLUDED.file_base_counts , "
                        + "file_base_size = EXCLUDED.file_base_size";
        SinkFunction<DomainCount> domainAssetsSink =
                JdbcSink.sink(
        ...
        tableCountsStreaming
                ...
                .name("domainAssetsSink");
        String userLevelAssetsSql =
                "INSERT INTO user_level_assets (creator, table_counts, partition_counts,"
                    + " file_counts, file_total_size, file_base_counts, file_base_size) VALUES (?,"
                    + " ?, ?, ?, ?, ?, ?) ON CONFLICT (creator) DO UPDATE SET table_counts ="
                    + " EXCLUDED.table_counts,partition_counts = EXCLUDED.partition_counts,"
                    + " file_counts = EXCLUDED.file_counts, file_total_size ="
                    + " EXCLUDED.file_total_size, file_base_counts = EXCLUDED.file_base_counts ,"
                    + " file_base_size = EXCLUDED.file_base_size";
        SinkFunction<UserCounts> userLevelAssetsSink =
                JdbcSink.sink(
                        userLevelAssetsSql,
                        (ps, t) -> {
        ...
        tableCountsStreaming
                ...
                .process(new UserLevelAssets())
                .addSink(userLevelAssetsSink)
                .name("userAssetsSink");
        env.execute();
    }
}
