...
public class UserLevelAssets
        extends KeyedProcessFunction<String, TableCountsWithTableInfo, UserCounts> {
    ...
    public void processElement(
            ...
            KeyedProcessFunction<String, TableCountsWithTableInfo, UserCounts>.Context context,
            Collector<UserCounts> collector)
            throws Exception {
