...
/** A factory able to create {@link FileWriterBucket} for the {@link LakeSoulMultiTablesSink}. */
@Internal
public interface FileWriterBucketFactory extends Serializable {

    FileWriterBucket getNewBucket(
            int subTaskId,
    ...
    FileWriterBucket restoreBucket(
            int subTaskId,
            TableSchemaIdentity tableId,
            BucketWriter<RowData, String> bucketWriter,
            RollingPolicy<RowData, String> rollingPolicy,
