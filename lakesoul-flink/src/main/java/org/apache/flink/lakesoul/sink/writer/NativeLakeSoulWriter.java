...
public class NativeLakeSoulWriter implements InProgressFileWriter<RowData, String> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NativeLakeSoulWriter.class);
    ...
    private void initNativeWriter() throws IOException {
        ...
        LOG.info("Initialized NativeLakeSoulWriter: {}", this);
    }
    ...
    public static class NativePendingFileRecoverableSerializer
        ...
        public InProgressFileWriter.PendingFileRecoverable deserialize(int version, byte[] serialized)
            ...
            return new NativeLakeSoulWriter.NativeWriterPendingFileRecoverable(path, time);
        }
    }
    ...
    @Override
    public void dispose() {
        LOG.info("Disposing NativeLakeSoulWriter...");
