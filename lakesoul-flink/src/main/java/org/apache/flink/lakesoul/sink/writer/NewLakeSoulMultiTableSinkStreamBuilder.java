...
public class NewLakeSoulMultiTableSinkStreamBuilder {
    ...
    public NewLakeSoulMultiTableSinkStreamBuilder(Source source, Context context, LakeSoulRecordConvert convert) {
        this.source = source;
