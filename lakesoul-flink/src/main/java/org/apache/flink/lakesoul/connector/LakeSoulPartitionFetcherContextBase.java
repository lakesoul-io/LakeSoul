...
public abstract class LakeSoulPartitionFetcherContextBase<P>
    ...
    public LakeSoulPartitionFetcherContextBase(
     ...
     *
     * <p>For 'create-time' and 'partition-time',the comparable object type is Long which represents
     * time in milliseconds, for 'partition-name', the comparable object type is String which
     * represents the partition names string.
     */
    @Override
    public List<ComparablePartitionValue> getComparablePartitionValueList() throws Exception {
        ...
        List<String> partitionDescs =
                this.dbManager.getTableAllPartitionDesc(tableInfo.getTableId());
    ...
    private ComparablePartitionValue<List<String>, String> getComparablePartitionByName(
        ...
        return new ComparablePartitionValue<List<String>, String>() {
            ...
            public List<String> getPartitionValue() {
                return extractPartitionValues(
                        partitionDesc.replaceAll(LAKESOUL_RANGE_PARTITION_SPLITTER, "/"));
            }
            ...
            public String getComparator() {
                ...
                if (simpleLatestPartition == 1) {
                    ...
                    Set<String> partitionOrderKeySet =
                            partitionOrderKeys == null
                                    ? new HashSet<>(partitionKeys)
                                    : new HashSet<>(
                                            Splitter.on(LAKESOUL_RANGE_PARTITION_SPLITTER)
                                                    .splitToList(partitionOrderKeys));
                    Map<String, String> parDescMap = DBUtil.parsePartitionDesc(partitionDesc);
                    // construct a comparator according to the order in which partitionOrderKeys
                    // appear in partitionKeys
    ...
    /**
     * close the resources of the Context, this method should call when the context do not need any
     * more.
     */
    @Override
