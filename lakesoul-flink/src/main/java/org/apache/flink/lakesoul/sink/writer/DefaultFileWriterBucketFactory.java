...
@Internal
public class DefaultFileWriterBucketFactory implements FileWriterBucketFactory {

    @Override
    public FileWriterBucket getNewBucket(
            int subTaskId,
    ...
    @Override
    public FileWriterBucket restoreBucket(
            int subTaskId,
            TableSchemaIdentity tableId,
            BucketWriter<RowData, String> bucketWriter,
            RollingPolicy<RowData, String> rollingPolicy,
            ...
            LakeSoulCDCComparator comparator)
            throws IOException {
        return FileWriterBucket.restore(subTaskId, tableId, bucketWriter,
