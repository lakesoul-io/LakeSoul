...
public class DomainLevelAssets
        extends KeyedProcessFunction<String, TableCountsWithTableInfo, DomainCount> {
    ...
    public void processElement(
            ...
            KeyedProcessFunction<String, TableCountsWithTableInfo, DomainCount>.Context context,
            Collector<DomainCount> collector)
            throws Exception {
