...
bitnami/spark:3.3.1 spark-submit --jars /opt/spark/work-dir/jars/lakesoul-spark-2.3.1-spark-3.3.jar --driver-memory 16G --executor-memory 16G --master "local[4]" --conf spark.pyspark.python=./venv/bin/python3 /opt/spark/work-dir/imdb/import_data.py
```
